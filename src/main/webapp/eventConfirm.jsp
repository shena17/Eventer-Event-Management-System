<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="com.service.EventServices" %>
    <%@page import="com.util.SupplierDB" %>
    <%@page import="com.util.venueDB" %>
            ...
            <div class="body">
                ...
                <div class="login-body">
                    ...
                    <div class="right">
                        ...
                        <p class="login-topic">Invoice</p>

                        <form action="confirmEvent" method="post">

                            <div class="input">
                                <label>Invoice</label>

                                <% int[] sup=EventServices.getList(); for(int s:sup){%>
                                    <%if(s!=0){ %>
                                        <% double cost=SupplierDB.getSupplierCost(s);%>

                                            <% String type=SupplierDB.getSupplierType(s);%>
                            ...
                            <%int id=EventServices.getVenue(); %>
                                <%double vCost=venueDB.getVenueCost(id); %>
                                    <div class="input">
                                        <div class="detail">
                                            <p>Venue Cost : $<%=vCost %>
                                            </p>
                                    ...
                                    <div class="prices">
                                        <p>Total Cost : $<%=EventServices.getBudget() %>
                                        </p>
                                    </div>

                                    <div><input type="submit" value="Confirm" class="login-btn">
                                    </div>
    ...
    <footer>
        ...
        <div class="footer">
            ...
            <div class="btm footerIcons">
                ...
                <p class="contactBar"><a href="#"><i class="fa-regular fa-envelope"></i>eventergroup@gmail.com</a></p>
